"""Calcula a escala/letterbox que ajusta a resolucao logica fixa do jogo a uma
janela real de qualquer proporcao, sem nunca cortar a imagem (R14.3).

Ao contrario do zoom/corte (`cover`: cresce ate cobrir a janela inteira,
