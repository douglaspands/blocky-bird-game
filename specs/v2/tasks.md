...
**Estado desta versão:** as tasks 1–19 são o histórico já concluído na v1 (mantidas aqui para o documento ser autocontido). As tasks 20–30 são o trabalho da v2 (Android), já concluídas. As tasks 31–37 são aumentos de escopo posteriores da v2 (qualidade, correções pós-lançamento e o ícone do aplicativo), também já concluídas.
