...
**Estado desta versão:** as tasks 1–19 são o histórico já concluído na v1 (mantidas aqui para o documento ser autocontido). As tasks 20–30 são o trabalho da v2 (Android), já concluídas. As tasks 31–32 são um aumento de escopo posterior da v2 (qualidade: conformidade com Ruff e calibração de fonte), também já concluídas.
...
Aumento de escopo pedido depois que as tasks 20–30 (Android) já estavam concluídas: conformidade com `ruff` em todo o código Python e calibração do tamanho de fonte para eliminar sobreposição de texto nas telas.
