...
| [v3](v3/) | **atual** — em andamento | Renomeia o jogo para **Blocky Bee** e resolve o aproveitamento de tela em todos os sistemas operacionais: tela cheia com canvas lógico na proporção real do aparelho e área jogável fixa em 480×720, sem barra preta e **sem alterar a dificuldade** — o espaço que sobra vira faixa decorativa (céu estendido, terra funda, corte transversal do subsolo e mobs do Minecraft). Traz também render acelerado por GPU por padrão com todo o conteúdo estático pré-renderizado, timestep fixo, qualidade adaptativa, e a camada de rigor SDD: docstrings obrigatórias, site de documentação, matriz de rastreabilidade verificada por teste e cobertura mínima no CI. Ver [v3/README.md](v3/README.md). |
