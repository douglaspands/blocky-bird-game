...
**Estado desta versão:** as tasks 1–19 são o histórico já concluído na v1 e as tasks 20–30 o histórico já concluído na v2 (Android) — mantidas aqui para o documento ser autocontido. As tasks **31–32 são o trabalho da v3** (conformidade com Ruff e calibração de fonte) e estão pendentes.
...
## Tarefas da v3 — Qualidade (pendentes)
...
- [ ] **32. Calibração de tamanho de fonte sem sobreposição**
