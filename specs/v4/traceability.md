...
> Chrome real confirma — sem esperar a task rodar primeiro, porque esses critérios nunca
> ganham teste automatizado, independentemente de estarem implementados. Critérios cuja
> implementação já existe mas não tem um teste dedicado — o gate é o próprio
...
> Android real comprova usam o mesmo marcador `manual`, seguindo o que `tasks.md` já separa
> em "Requer aparelho Android real"/"Requer verificação manual no Chrome".
...
| R41.2 | 52 | 95 | `test_repo_hygiene.py::test_release_workflow_attaches_the_web_build_as_a_fourth_asset` |
| R41.3 | 52 | 97 | manual |
| R41.4 | 53 | 97 | manual |
