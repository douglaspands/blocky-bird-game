"""Fixtures globais do pytest: isolamento de estado entre os testes do jogo."""
...
@pytest.fixture(autouse=True)
def _reset_viewport():
    """Reseta o viewport global que Game define ao criar o display (960x720 no desktop).

    Sem este reset, o canvas de um teste vazaria para o proximo — os
...
@pytest.fixture(autouse=True)
def _reset_display():
    """Recria o display: pygame.SCALED exige um renderer SDL e o driver dummy so permite um por processo.

    Sem isso, o 2o+ set_mode(SCALED) do processo falha com
